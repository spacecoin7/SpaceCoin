...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 12063 or testnet: 12068)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 12064 or testnet: 12069)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Spacecoin Wiki for SSL setup instructions)") + "\n" +
